...
public class newPilotoAdapter extends BaseAdapter {

    Context context;
    ArrayList<String> items;
    private LruCache<String, Bitmap> mMemoryCache;

    public newPilotoAdapter(Context context, ArrayList<String> items) {
...
//        android:layout_centerInParent="true"
        if (convertView == null) {
            ...
            img.setLayoutParams(new GridView.LayoutParams(LayoutParams.FILL_PARENT, 400));
        } else {
    ...
    class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer... params) {
            ...
            final Bitmap bitmap = decodeSampledBitmapFromResource(
                    context.getResources(), data, 300, 200);
